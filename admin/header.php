...
<body>
    ...
    <div class="container p-2">
                <a class="navbar-brand" href="produk.php" style="font-weight: 600;">Toko Snack</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="tampil_user.php">Pelanggan</a>
                        </li>
                        <li class="nav-item">
    ...
    <!-- <div class="container-fluid">
        <a class="navbar-brand" href="#">Toko Snack</a>
