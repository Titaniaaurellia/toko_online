...
<html lang="en">
  ...
  <body>
    ...
    <div class="card my-4 mx-4 p-3">
      <img src="<?php echo "foto_produk/".$data_produk['foto']; ?>" class="card-img-top" alt="product picture" width="200" height="200" />
      <div class="card-body">
        ...
        <a href="detail_produk.php?id_produk=<?=$data_produk['id_produk']?>" class="btn btn-success">Beli</a>
      </div>
    </div>
    <?php
      }
